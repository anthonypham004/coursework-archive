...
# self-learning "router". It was written in Python v3.
...
def _handle_PacketIn(event):
  ...
  because the router doesn't have a matching rule for the packet it received.
  '''
  ...
  # Extract the number of ports attached to the sending switch. This variable 
  # should be used when updating your global flood counter.
