...
class AssignmentNetworks(Topo):
    def __init__(self, **opts):
        ...
        # See Section 5 of the project instructions to better understand what
        # these levels mean. 

        # NOTE: Do NOT modify these parameters. Only use them when you 
        # construct the Topology B below.
        lvl1_bw = 150
        lvl2_bw = 65
        lvl3_bw = 20
        ...
        # TODO: Build Topology B starting here. See Section 5 of the project
        # instructions to know what the topology should look like. Also, make
        # sure to use topology-a.py as a guide when implementing this file.
	    ...
	    # Add links between each host and the edge switches.
