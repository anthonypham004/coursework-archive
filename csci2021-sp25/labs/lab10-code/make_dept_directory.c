/* Create a binary file which has the following structure.
    ...
    following. Note that offsets are given by line numbers while in the binary
...
contact_t ee_dept[] = {
    {"Mehmet Akcakaya", "akcakaya@umn.edu"}, {"Massoud Amin", "amin@umn.edu"},
    {"Raj Aravalli", "aravalli@umn.edu"},    {"Kia Bazargan", "kia@umn.edu"},
    {"Itshak Bergel", "ibergel@umn.edu"},    {"Stephen Campbell", "scampbell@umn.edu"},
};

contact_t it_dept[] = {
    {"Joseph Axberg", "jaxberg@umn.edu"},  {"Carl Follstad", "follstad@umn.edu"},
    {"Valarie Griep", "griep003@umn.edu"}, {"Richard Howey", "howe0156@umn.edu"},
